...
const showHostedSignupMarketing = computed(
  () =>
    !globalConfig.value.publicBrandProfile &&
    globalConfig.value.deploymentEnv === 'cloud'
);

onBeforeMount(() => {
  isLoading.value = showHostedSignupMarketing.value;
});
...
<template>
  ...
  >
    ...
    <div
      ...
      :class="{ 'w-auto xl:w-full': showHostedSignupMarketing }"
    >
      ...
      <Testimonials
        v-if="showHostedSignupMarketing"
